...
class EmailTemplateController extends Controller
{
    ...
    {
        try {
            // Solo administradores pueden crear plantillas de correo
            // Ajusta esta verificación según tu sistema de roles
            if (!$request->user() || !$request->user()->hasRole('admin')) {
                return $this->apiForbidden('No tienes permisos para crear plantillas de correo', 'FORBIDDEN');
            }
    ...
    {
        try {
            // Solo administradores pueden actualizar plantillas de correo
            // Ajusta esta verificación según tu sistema de roles
            if (!$request->user() || !$request->user()->hasRole('admin')) {
                return $this->apiForbidden('No tienes permisos para actualizar plantillas de correo', 'FORBIDDEN');
            }
    ...
    {
        try {
            // Solo administradores pueden eliminar plantillas de correo
            // Ajusta esta verificación según tu sistema de roles
            if (!$request->user() || !$request->user()->hasRole('admin')) {
                return $this->apiForbidden('No tienes permisos para eliminar plantillas de correo', 'FORBIDDEN');
            }
    ...
    {
        try {
            // Solo administradores pueden restaurar plantillas de correo
            // Ajusta esta verificación según tu sistema de roles
            if (!$request->user() || !$request->user()->hasRole('admin')) {
                return $this->apiForbidden('No tienes permisos para restaurar plantillas de correo', 'FORBIDDEN');
            }
